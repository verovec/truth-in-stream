...
func resetSchema(ctx context.Context, t *testing.T, dsn string) {
	...
	if _, err := pool.Exec(ctx, "DROP TABLE IF EXISTS claims, documents, document_sentences, document_claims, videos, wiki_chunks, wiki_sync_state, political_claims, voting_records"); err != nil {
