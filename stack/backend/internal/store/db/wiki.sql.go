...
func (q *Queries) CountWikiPages(ctx context.Context, excludeCorpora []string) (int64, error) {
	row := q.db.QueryRow(ctx, countWikiPages, excludeCorpora)
	var column_1 int64
...
func (q *Queries) EmbeddedWikiChunks(ctx context.Context, arg EmbeddedWikiChunksParams) ([]EmbeddedWikiChunksRow, error) {
	rows, err := q.db.Query(ctx, embeddedWikiChunks,
		arg.ExcludeCorpora,
		arg.AfterPageID,
		arg.AfterChunkIndex,
		arg.RowLimit,
