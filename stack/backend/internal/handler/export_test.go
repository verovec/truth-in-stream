...
func newExportServer(videos VideoService, replayer AnalysisReplayer) http.Handler {
	...
	return NewMux(health, videos, &fakeVideoAnalysisService{}, &fakeDocumentService{}, &fakeDocumentAnalyzer{}, &fakeYouTubeService{}, &fakeTVChannelService{}, &fakeTVRecordingService{}, testTVHub(), stubLiveAnalyzer{}, nil, replayer, nil, false, nil, "", globalTestAuth, logger)
}
