...
func newDocumentsTestServer(svc *fakeDocumentService) http.Handler {
	...
	return NewMux(health, &fakeVideoService{}, svc, &fakeDocumentAnalyzer{}, &fakeYouTubeService{}, &fakeTVChannelService{}, stubLiveAnalyzer{}, nil, nil, nil, false, nil, "", globalTestAuth, logger)
}
