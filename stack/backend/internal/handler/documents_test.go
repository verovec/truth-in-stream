...
func newDocumentsTestServer(svc *fakeDocumentService) http.Handler {
	...
	return NewMux(health, &fakeVideoService{}, &fakeVideoAnalysisService{}, &fakeVideoAnalysisStarter{}, svc, &fakeDocumentAnalyzer{}, &fakeYouTubeService{}, &fakeTVChannelService{}, &fakeTVRecordingService{}, testTVHub(), stubLiveAnalyzer{}, nil, nil, nil, false, nil, "", globalTestAuth, logger)
}
