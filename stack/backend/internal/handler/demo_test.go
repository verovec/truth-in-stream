...
func newDemoServer(dir string) http.Handler {
	...
	return NewMux(hc, &fakeVideoService{}, &fakeDocumentService{}, &fakeDocumentAnalyzer{}, &fakeYouTubeService{}, &fakeTVChannelService{}, testTVHub(), stubLiveAnalyzer{}, nil, nil, nil, false, nil, dir, globalTestAuth, logger)
}
