...
func TestExportEndToEndOverRedis(t *testing.T) {
	...
	srv := httptest.NewServer(NewMux(health, videos, &fakeDocumentService{}, &fakeYouTubeService{}, stubLiveAnalyzer{}, persister, reader, nil, false, nil, "", globalTestAuth, logger))
	t.Cleanup(srv.Close)
