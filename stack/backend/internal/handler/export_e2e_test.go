...
func TestExportEndToEndOverRedis(t *testing.T) {
	...
	srv := httptest.NewServer(NewMux(health, videos, &fakeVideoAnalysisService{}, &fakeVideoAnalysisStarter{}, &fakeDocumentService{}, &fakeDocumentAnalyzer{}, &fakeYouTubeService{}, &fakeTVChannelService{}, &fakeTVRecordingService{}, testTVHub(), stubLiveAnalyzer{}, persister, reader, nil, false, nil, "", globalTestAuth, logger))
	t.Cleanup(srv.Close)
