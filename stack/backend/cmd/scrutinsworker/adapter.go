...
// transport-free interfaces, so internal/scrutinsjob never imports
// internal/queue.

// qDelivery adapts a queue.Delivery to scrutinsjob.Delivery.
...
// qEnqueuer adapts a queue.Client to scrutinsjob.Enqueuer for bounded retries.
