...
// VerifiedClaim is the verdict view for a resolved claim: the verdict badge, its
// source and confidence, and the citations and rationale revealed on tap. It is
// shared by the inline per-statement claim list and the decoupled fact-check
// section so the two render one claim identically. A degenerate verified frame
// with no verdict (defensive) reads as unverifiable rather than a blank row.
