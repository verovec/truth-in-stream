...
This project is indexed by GitNexus as **truth-in-stream** (23905 symbols, 67257 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
