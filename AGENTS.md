...
This project is indexed by GitNexus as **truth-in-stream** (24385 symbols, 68609 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
